...
public class Example1Parser extends Parser {
	...
	public static final int
		...
		RULE_for_statement = 7, RULE_for_first_part = 8, RULE_for_secomd_part = 9, 
		RULE_block = 10, RULE_for_statement_variable_number = 11, RULE_type = 12, 
		RULE_expr = 13, RULE_call_function = 14, RULE_adding_one = 15, RULE_minus_one = 16, 
		RULE_fast_math = 17, RULE_for_statement_adding_one = 18, RULE_for_statement_minuss_one = 19, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"function", "function_parameters", "for_statement", "for_first_part", 
			"for_secomd_part", "block", "for_statement_variable_number", "type", 
			"expr", "call_function", "adding_one", "minus_one", "fast_math", "for_statement_adding_one", 
			"for_statement_minuss_one", "number_attribute", "code_attribute", "else_statment", 
	...
	public final For_first_partContext for_first_part() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_for_first_part);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(173);
	...
	public final For_secomd_partContext for_secomd_part() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_for_secomd_part);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(177);
	...
	public final For_statement_variable_numberContext for_statement_variable_number() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_for_statement_variable_number);
		try {
			setState(203);
			_errHandler.sync(this);
	...
	public final Adding_oneContext adding_one() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_adding_one);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(247);
	...
	public final Minus_oneContext minus_one() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_minus_one);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(250);
	...
	public final Fast_mathContext fast_math() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_fast_math);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final For_statement_adding_oneContext for_statement_adding_one() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_for_statement_adding_one);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(257);
	...
	public final For_statement_minuss_oneContext for_statement_minuss_one() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_for_statement_minuss_one);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(260);
