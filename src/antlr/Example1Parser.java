...
public class Example1Parser extends Parser {
	...
	public static final int
		...
		RULE_assignment = 30, RULE_print_statements = 31, RULE_widget = 32, RULE_image = 33, 
		RULE_image_assets = 34, RULE_text = 35, RULE_column = 36, RULE_row = 37, 
		RULE_container = 38, RULE_container_att = 39, RULE_scaffold = 40, RULE_body = 41, 
		RULE_color = 42, RULE_width = 43, RULE_height = 44, RULE_e_button = 45, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"widget", "image", "image_assets", "text", "column", "row", "container", 
			"container_att", "scaffold", "body", "color", "width", "height", "e_button", 
			"elevatedButtonWidgetArgs", "elevatedButtonWidgetArg", "voidFunction", 
			"center", "centerWidgetArgs"
		};
	}
